...
<div class="topbar">
  ...
  <div class="topbar-item">
    ...
    <div class="btn btn-icon w-auto btn-info d-flex align-items-center btn-lg px-2">
      <span class="text-light-50 font-weight-bolder font-size-base d-none d-md-inline mr-2">
